...
public class QFJCodec implements IPipelineCodec {
    ...
    @Override
    public @NotNull MessageGroup decode(@NotNull MessageGroup messageGroup, @NotNull IReportingContext iReportingContext) {
        ...
        iterator.forEachRemaining(field -> {
            ...
            if (dataDictionary.isGroup(msgType, field.getTag())) {
                ...
                if (replaceValuesWithEnumNames) {
                    ...
                    messageBuilder.putFields(dataDictionary.getFieldName(field.getTag()), ValueUtils.toValue((String) field.getObject()));
                }
            }
        });
